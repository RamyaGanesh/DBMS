 ...
 * @author rg69519
 */
@WebServlet(name = "AddextraCost", urlPatterns = {"/AddextraCost"})
public class AddextraCost extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try
       {
           ...
           String sql = "update appointments set extracost = '" + notes + "' where appointmentid = " + appid ;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AddextraCost.class.getName()).log(Level.SEVERE, null, ex);
