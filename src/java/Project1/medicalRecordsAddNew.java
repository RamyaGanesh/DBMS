 ...
 * @author rg69519
 */
@WebServlet(name = "medicalRecordsAddNew", urlPatterns = {"/medicalRecordsAddNew"})
public class medicalRecordsAddNew extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try
       {
           ...
           String sql ="INSERT INTO medicalRecords (appointmentId, typeOfAilment, treatmentGiven) VALUES ("
                   + appid + ", '" + toa + "', '" + tg + "')";
		...
		ResultSet result = preStatement.executeQuery();
              ...
              {
                  request.setAttribute("addmr", "Error: inavlid data");
                  request.getRequestDispatcher("/AddMedicalRecord.jsp").forward(request, response);
                }
              request.setAttribute("addmrmessage1", "RECORD ADDED");
              request.setAttribute("addmrmessage", "RECORD ADDED");
