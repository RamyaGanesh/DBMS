...
public class CancelAppointment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try
       {
           ...
           int appid = Integer.parseInt(request.getParameter("cancelapp").trim());
           String sql = "update appointments set status = 'c' where appointmentid = " + appid ;
           PreparedStatement preStatement = conn.prepareStatement(sql);
              ResultSet result = preStatement.executeQuery();
            String sql1 = "delete from payments where appointment id = " + appid ;
